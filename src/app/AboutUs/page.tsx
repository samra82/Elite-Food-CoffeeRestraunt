  ...
  return (
    <section className="bg-black px-3 md:px-[135px] flex flex-col justify-evenly md:flex-row md:items-center py-[50px]">
      ...
      <div className="mt-[50px] md:mt-0 ">
        <Image src="assets/footer-1.svg" width={20} height={20} alt="About Us Image 1" className="" />
        <div className="flex flex-col md:flex-row mt-[16px] md:mt-[0]">
          <Image src="assets/footer-1.svg"  width={20} height={20} alt="About Us Image 2" className="mr-[16px] pt-[40px]" />
          <Image src="assets/footer-1.svg" width={20} height={20} alt="About Us Image 3" className="pt-[40px]" />
        </div>
      </div>
    </section>
  );
